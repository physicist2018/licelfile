...
- **`NewLicelPack`**: `StartTime` теперь корректно вычисляется как минимальное время начала среди всех загруженных файлов (а не время первого файла). `StopTime` — максимальное время окончания.
