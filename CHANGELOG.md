...
- **Тесты**: 7 тестов `TestLicelFile_Glue_*` (успешная склейка, отсутствие аналогового/цифрового канала, h1 ≥ h2, h1 вне диапазона, все нули в фотонном канале, разная длина данных).
